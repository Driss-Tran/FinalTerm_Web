...
<body>
    ...
    <div class="container tableList">
        <h2 class="header_table">Danh sách khách hàng đang chờ xác nhận giao dịch</h2>
        <table class="table" id="listTransfer">
            <thead>
                <tr class="tr">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="accepted" class="btn btn-primary">Đồng ý</button>
                        </div>
                    </div>
                </div>
            </div>
