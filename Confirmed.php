...
<body>
    ...
    <div class="container tableList">
        ...
        <table class="table" id="confirmedUsersTbl">
            <thead>
                <tr class="tr">
                    ...
                    <th class="th" scope="col">Ngày tháng năm</th>
        ...
        <div>
            <a href="#" class="btn btn-primary">Danh sách các giao dịch </a>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <div class="form-group">
                                    <input type="hidden" class="form-control" id="detail-ID" name='id'>
                                </div>
